  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 ">
      ...
      <div className="md:w-1/2 relative flex justify-end items-end">
        <iframe
          className="w-full h-64 sm:h-80 md:h-[410px] md:w-[410px] object-contain"
          src="https://lottie.host/embed/8f43507b-5b72-4b70-ae19-14a210154511/8agSggqZ9K.lottie"
        ></iframe>

        {/* If you want to use image instead of iframe */}
        {/* <img
